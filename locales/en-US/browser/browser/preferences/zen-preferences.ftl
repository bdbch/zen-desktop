...
sync-engine-workspaces =
    ...
    .tooltiptext = SidebarSync syncs workspace sidebar structure across your devices.
    .accesskey = W
sync-engine-workspaces-description = SidebarSync syncs workspace sidebar structure across your devices: workspaces, folders, and pinned/essential tab URLs.
sync-engine-workspaces-warning = SidebarSync does not sync regular unpinned open tabs.
sync-engine-workspaces-difference = SidebarSync is separate from same-device Window Sync and Firefox "tabs from other devices".
sync-sidebarsync-what-syncs-link = What syncs?
sync-sidebarsync-recovery-title = Sidebar state recovery
sync-sidebarsync-recovery-description = Restore your last local sidebar snapshot (workspaces, folders, pinned tabs, and essential tabs) on this device. Restore pauses SidebarSync until you resume.
sync-sidebarsync-recovery-restore-button = Restore sidebar state
sync-sidebarsync-recovery-resume-button = Resume sync and upload restored state
sync-sidebarsync-recovery-confirm-title = Restore sidebar state?
sync-sidebarsync-recovery-confirm-message = This restores the last local snapshot of workspaces, folders, pinned tabs, and essential tabs on this device only. It does not restore regular unpinned open tabs. SidebarSync will be paused after restore.
sync-sidebarsync-recovery-complete-title = Sidebar state restored
sync-sidebarsync-recovery-complete-message = Sidebar state was restored locally and SidebarSync is now paused.
sync-sidebarsync-recovery-resume-complete-title = SidebarSync resumed
sync-sidebarsync-recovery-resume-complete-message = SidebarSync resumed. The next sync uploads this restored sidebar state from this device.
sync-sidebarsync-recovery-no-snapshot-title = No local snapshot found
sync-sidebarsync-recovery-no-snapshot-message = SidebarSync could not find a local recovery snapshot to restore.
sync-sidebarsync-recovery-error-title = SidebarSync recovery failed
sync-sidebarsync-recovery-error-message = SidebarSync could not complete this recovery action. Please try again.
